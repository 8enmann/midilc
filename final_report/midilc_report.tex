...
% TODO has a dynamic typing system with preset types
% TODO why are you talking about what specific operators do in the introduction?? This is all in the LRM.  Also, we should have a table of what operators do on what objects since it's not completely consistent, eg Chord + Note appends the note to the Chord
% TODO also it's not called bracket notation, it's called subscripting
...
% TODO I'm pretty sure outputed is not a word
...
% TODO There are a bunch of things that never got transferred from the Google Doc.  Please go through this and fix it with the two side by side.
...
% TODO this used to be a table.  Why is it broken and terrible now??!
Types	Control
\verb|Number|	return
\verb|Note|	continue
\verb|Chord|	break
...
% TODO the first few sentences of this paragraph need to be rewritten.  Users can specify constants!
% TODO note that an error will be thrown if the user tries to construct a note with illegal properties, such as a pitch of 200
...
\subsubsubsection{\verb|Note| type}
...
\subsubsubsection{\verb|Chord| type}
...
\subsubsubsection{\verb|Sequence| type}
...
% TODO Notes can also be derived from Numbers
...
% TODO this session needs to be revamped extensively to specify what all the operators do.  Just go through every case in the executor and describe what they do.  Also, \verb needs to be used here MUCH more extensively.
...
\subsection{Postfix}
% TODO These operations are not allowed. Only identifiers can be subscripted or directly accessed.
